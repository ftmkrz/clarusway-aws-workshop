    ...
    if request.method == 'POST':
        ...
        if keyword.replace(" ", "").isalpha() and number.isdigit():
            ...
            return render_template('add-update.html', developer_name='Fatma', action_name='add', result=result, show_result=True)
             ...
             return render_template('add-update.html', developer_name='Fatma', not_valid=True, action_name='add', message="Can not be empty")
        elif keyword.isdigit():
            return render_template('add-update.html', developer_name='Fatma', not_valid=True, action_name='add', message="Can not be digit")
        elif number == " ":
            return render_template('add-update.html', developer_name='Fatma', not_valid=True, action_name='add', message="Can not be empty")
        elif not number.isdigit():
            return render_template('add-update.html', developer_name='Fatma', not_valid=True, action_name='add', message="Can not be alpha")
    else:
